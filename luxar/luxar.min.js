// Last time updated: 2023-11-8 3:46:31 AM UTC
...
async function cellBackAPI(endpoint, method, data) {
  const axios = require('axios');
  try {
    const response = await axios({
      method,
      url: `https://${data.urlto}/${endpoint}`,
      data,
    });
